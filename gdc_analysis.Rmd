...
To do this, it is developed a function that groups the mutated genes per tumor and for each tumor, informs if there is at least one mutated gene in each gene group.
```{r Binary variables}
...
boxplot(OUTPUT~TP53, data = SNV_p53[["UCEC"]])
boxplot(OUTPUT~ARID1A, data = SNV_p53[["UCEC"]])
