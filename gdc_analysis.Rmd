...
lasso_plot <- function(processed_data, gene_group = pathways_list, save = F, folder = "Resultados/", file = deparse(substitute(processed_data)), format = ".png", ...){
