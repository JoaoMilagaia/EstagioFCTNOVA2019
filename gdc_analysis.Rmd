...
To do this, it is developed a function that groups the gene variants per tumor and for each tumor, informs if there is at least one gene variant in each gene group.
```{r Binary variables}
