...
genome_pik <- with(pathways_list, c(Genome_integrity,PIK_signalling)); names(genome_pik) <- genome_pik
...
SNV_allgenes <- process(SNV_data, genes_per_cancer, one_for_all = F)
